            ...
            <div className='boxCenter w-full'>
                <div className='md:flex-row md:gap-0 gap-10 p-4 h-[500px] flex-col flex shadow-2xl   items-center containerBox'>
                    ...
                    <div className='md:w-[40%] w-full gap-3 h-full  p-4 boxCenter relative flex-col thmeLightBg'>
                        ...
                        <h1 className='text-[19px] mt-3 font-semibold text-white'>Register</h1>
                        <form onSubmit={handleClick} className='flex gap-4 mt-3 flex-col w-full'>
                            <input id='email' onChange={handleChange} type='text' required placeholder='name' className='p-1 text-gray-500 text-[15px]' />
                            <input id='name' onChange={handleChange} type='email' required placeholder='email' className='p-1 text-gray-500 text-[15px]' />
                            ...
                            <div className='boxCenter w-full'>
                                <button className='btnWhite whitespace-nowrap'>Create Account</button>
                            </div>
                        </form>
                        <div className='boxCenter mt-3 w-full gap-2'>
                            <span className='text-white text-[14px] '>Don't have an account? </span>
                            <Link to='/login' className='themeColor hover:border-b hover:border-white border-teal-800 border-b py-[2px] text-[16px] font-semibold'>Login</Link>
                        </div>
